...
public class ProductLoader implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public void onApplicationEvent(ContextRefreshedEvent event) {
        ...
        Product product1 = new Product(name, description, imgUrl, price, new Date());
        ...
        Product product2 = new Product(name, description, imgUrl, price, new Date());
        ...
        Product product3 = new Product(name, description, imgUrl, price, new Date());
        ...
        Product product4 = new Product(name, description, imgUrl, price, new Date());
        ...
        Product product5 = new Product(name, description, imgUrl, price, new Date());
        ...
        Product product6 = new Product(name, description, imgUrl, price, new Date());
        ...
        Product product7 = new Product(name, description, imgUrl, price, new Date());
        ...
        Product product8 = new Product(name, description, imgUrl, price, new Date());
        ...
        Product product9 = new Product(name, description, imgUrl, price, new Date());
        ...
        Product product10 = new Product(name, description, imgUrl, price, new Date());
        ...
        Product product11 = new Product(name, description, imgUrl, price, new Date());
        ...
        Product product12 = new Product(name, description, imgUrl, price, new Date());
